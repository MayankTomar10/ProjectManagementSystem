    ...
    return (
        ...
        <>
            ...
            <div class="container-fluid bg-dark text-secondary text-center border-top py-4 px-5"
                style={{ "border-color": "rgba(256, 256, 256, .1) !importan" }}>
                <p class="m-0">&copy; <a class="text-secondary border-bottom" href="#">PMS</a>. All Rights
                    Reserved. Designed by <a class="text-secondary border-bottom" href="">HTML
                        Codex</a></p>
            </div>
        </>
